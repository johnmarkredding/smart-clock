...
function getWeather() {
	...
	$.getJSON(apiURL, function (data) {
		var weatherData = data, tempDegrees = "35", iconName;
...
$(document).ready(function () {
	...
	var icons = new Skycons({"color": "#FFE649"}), list = ["clear-day", "clear-night", "partly-cloudy-day", "partly-cloudy-night", "cloudy", "rain", "sleet", "snow", "wind", "fog"], i;
